...
def pbBerryPlant
  ...
  if Settings::NEW_BERRY_PLANTS
    ...
    if berry_plant.mulch_id
      ...
      $msg_style = :system
      command = pbMessage(_INTL("It's soft, earthy soil."),
    ...
    # Old mechanics
    $msg_style = :system
    if !pbConfirmMessage(_INTL("It's soft, loamy soil. Want to plant a berry?"))
      $msg_style = nil
      return 
    end
    $msg_style = nil
