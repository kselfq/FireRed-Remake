#===============================================================================
#  Common Animation: SHADOWAURA
#===============================================================================
EliteBattle.defineCommonAnimation(:SHADOWAURA) do
  #-----------------------------------------------------------------------------
  #  hides UI elements
  ...
  for i in 0...16
    ...
    fp["c#{i}"].bitmap = pbBitmap(sprintf("Graphics/EBDX/Animations/Moves/ebShadowAura%03d",rand(4)+1))
    fp["c#{i}"].center!
    fp["c#{i}"].opacity = 0
  end
  #-----------------------------------------------------------------------------
  ...
  for j in 0...8
    ...
    fp["r#{j}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/ebShadowAura005")
    fp["r#{j}"].ox = 0
  ...
  for j in 0...3
    ...
    fp["v#{j}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/ebShadowAura006")
    fp["v#{j}"].center!
    fp["v#{j}"].x = cx
    fp["v#{j}"].y = cy
    fp["v#{j}"].opacity = 0
