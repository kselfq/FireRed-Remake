...
#  SHADOWEND
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWEND) do
  ...
  for i in 0...8
    ...
    fp["#{i}s"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb628_20")
  ...
  fp["shot"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb628_21")
