...
#  SPITE
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SPITE) do | args |
  EliteBattle.playMoveAnimation(:HEX, @scene, @userIndex, @targetIndex, @hitNum, @multiHit, nil, false)
end
#-------------------------------------------------------------------------------
#  HEX
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:HEX) do
  ...
  fp["bg"].speed = 6
  fp["bg"].setBitmap("Graphics/EBDX/Animations/Moves/eb453",true)
  ...
  for i in 0...72
    pbSEPlay("EBDX/Anim/ghost2",80) if i == 40
    pbSEPlay("EBDX/Anim/ghost3",80) if i == 62
    if i < 10
      fp["bg"].opacity += 25.5
    elsif i < 20
