...
#  SHADOWBREAK
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWBREAK) do
  ...
  fp["bg"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb614_bg_10")
  fp["bg"].color = Color.new(0,0,0,255)
  fp["bg"].opacity = 0
  for j in 0...16
    fp["f#{j}"] = Sprite.new(@viewport)
    fp["f#{j}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb614_20")
  ...
  for j in 0...32
    ...
    fp["#{j}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb615_20") #dragondance
  ...
  for j in 0...8
    ...
    fp["s#{j}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb057_20")#keep
  ...
  fp["flare"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb614_220")
  ...
  for j in 0...3
    ...
    fp["#{j}x"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb244_20")
  ...
  for m in 0...12
    ...
    fp["p#{m}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb614_20")
