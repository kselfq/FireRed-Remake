...
#  Shadow Bolt
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWBOLT) do | args |
  ...
  for i in 0...8
    ...
    fp["#{i}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb069_1_2")
  ...
  for i in 0...16
    ...
    fp["s#{i}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb069_1_3")
  ...
  fp["circle"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb069_1_0")
  ...
  for i in 0...96
    ...
    for n in 0...16
      ...
      if fp["s#{n}"].opacity == 0 && fp["s#{n}"].tone.gray == 0
        ...
        fp["s#{n}"].tone = rand(2)==0 ? Tone.new(150,0,200) : Tone.new(0,0,0)
