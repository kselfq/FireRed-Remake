...
#  SHADOWSHED
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWSHED) do
  ...
  fp["bg"].bitmap.fill_rect(0,0,fp["bg"].bitmap.width,fp["bg"].bitmap.height,Settings::SHADOWPOKEMON_COLOR)
  fp["bg"].opacity = 0
  fp["bg2"] = Sprite.new(@viewport)
  fp["bg2"].bitmap = Bitmap.new(@viewport.width,@viewport.height)
  fp["bg2"].bitmap.fill_rect(0,0,fp["bg2"].bitmap.width,fp["bg2"].bitmap.height,Settings::SHADOW_MOVES_COLOR)
  fp["bg2"].opacity = 0
  16.times do
    fp["bg2"].opacity += 12
    @scene.wait(1,true)
  ...
  for j in 0...5
    ...
    fp["#{j}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb458_17")
  ...
  fp["ring"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb458_16")
