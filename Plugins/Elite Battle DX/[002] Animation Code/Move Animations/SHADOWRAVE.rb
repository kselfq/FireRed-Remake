...
#  SHADOWRAVE
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWRAVE) do
  fp = {}
  ...
  for k in 0...3
    ...
    fp["f#{k}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb224_3")
    ...
    for m in 0...16
      ...
      fp["p#{k}#{m}"].ox = 4
      fp["p#{k}#{m}"].oy = 4
      c = [Settings::SHADOWPOKEMON_COLOR,Settings::SHADOW_MOVES_COLOR][rand(2)]
