...
#  SHADOWDOWN
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWDOWN) do
  ...
  fp["blade"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb458_20")
  ...
  fp["blade2"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb458_20")
