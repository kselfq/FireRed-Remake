...
#  SHADOWSKY
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWSKY) do
  ...
  fp["weatherball"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb156_1_0")
  ...
  fp["dnt"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb156_1_2")
