...
#  SHADOWWAVE
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWWAVE) do
  ...
  fp["bg"].speed = 64
  fp["bg"].setBitmap("Graphics/EBDX/Animations/Moves/eb086_bg_8")
  fp["bg"].color = Settings::SHADOW_MOVES_COLOR
  fp["bg"].opacity = 0
  fp["cir"] = Sprite.new(@viewport)
  fp["cir"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb093_1_5")
  ...
  for i in 0...8
    ...
    fp["#{i}s"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb093_2_5")
  ...
  fp["shot"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb093_3_5")
