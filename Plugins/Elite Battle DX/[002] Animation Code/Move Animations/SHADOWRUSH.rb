...
#  SHADOWRUSH
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWRUSH) do
  ...
  for i in 0...16
    ...
    fp["#{i}"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb59_3_4")
    fp["#{i}"].ox = 6
    fp["#{i}"].oy = 6
    fp["#{i}"].opacity = 0
    fp["#{i}"].z = 50
  ...
  frame.z = 50
  frame.bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb520_5")
