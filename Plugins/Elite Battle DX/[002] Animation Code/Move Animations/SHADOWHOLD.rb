...
#  SHADOWHOLD
#-------------------------------------------------------------------------------
EliteBattle.defineMoveAnimation(:SHADOWHOLD) do
  # set up animation
  fp = {}
  ...
  fp["wrap1"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb028_8")
  ...
  fp["wrap2"].bitmap = pbBitmap("Graphics/EBDX/Animations/Moves/eb028_8")
