...
module BattleScripts
  ...
  BROCK = {
    "turnStart0" => proc do
      ...
      @scene.pbTrainerSpeak(["Time to set this battle into motion! Motion is motion.",
      ...
      @scene.pbDisplay("#{tname} tossed an item to the #{pname} ... It's so rico to taste for you dippy dippy!")
      ...
      # show generic text
      @scene.pbDisplay("The battle is getting intense! You see the lights and stage around you shift. So something will shine upon you!")
